              ...
              <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                  <div className='flex flex-col gap-2'>
                    ...
                    name='game'
                    id="game"
                    className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500' defaultValue="">
                  ...
                  <div className='flex gap-6'>
                    ...
                    className='grid grid-cols-4 gap-2' value={weekDays} onValueChange={setWeekDays}>
                    <ToggleGroup.Item
                        value='0'
                        title='Domingo'
                  ...
                  <footer className='mt-4 flex justify-end gap-4'>
                    ...
                    ><GameController size={24}/> Encontrar duo</button>
